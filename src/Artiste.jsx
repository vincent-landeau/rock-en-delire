        ...
        <div className="container artiste-container">
          <div className="artiste grid-container">
            ...
            <div className="artiste-image">
              <div style={{"backgroundImage":"radial-gradient(circle farthest-corner at 50% 50%, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.8)), url("+process.env.PUBLIC_URL + artiste['url-image']+")"}}></div>
            </div>
